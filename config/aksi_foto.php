...
if(isset($_POST['hapus'])){
    ...
    $query = mysqli_query($koneksi, "SELECT * FROM gallery_foto WHERE FotoId='$FotoId'");
        ...
        $sql = mysqli_query($koneksi, "DELETE FROM gallery_likefoto WHERE FotoId='$FotoId'");
        $sql = mysqli_query($koneksi, "DELETE FROM gallery_komentarfoto WHERE FotoId='$FotoId'");
