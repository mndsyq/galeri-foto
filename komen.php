...
<body>
    ...
    <div class="container-fluid px-5 my-4">
        ...
        $sql = mysqli_query($koneksi, "SELECT * FROM gallery_foto INNER JOIN gallery_user ON gallery_foto.UserId = gallery_user.UserId
        INNER JOIN gallery_album ON gallery_foto.AlbumId = gallery_album.AlbumId WHERE FotoId='$FotoId'");
        ...
        <div class="offset-1 col-10">
            <div class="card shadow " style="max-width: 100%;">
                <div class="row g-0">
                    <div class="col-7">
                        <img src="gbr/<?php echo $data['LokasiFile']?>" class="img-fluid card-img-top object-fit-cover"
                            alt="...">
                    </div>
                    <div class="col-5">
                        <div class="card-body justify-content-between">
                            <a href="profil.php?UserId=<?= $data['UserId']?>" class="text-decoration-none">
                                <p class="text-black fw-bold" style="font-size: 140%;"> <?php echo $data['Username']?>
                                </p>
                            </a>
                            <strong><span class="badge bg-secondary "><?php echo $data['NamaAlbum']?></span></strong>
                            <div class="d-flex align-items-center justify-content-between">
                                <small class="fw-bold" style="font-size:100%;"><?php echo $data['JudulFoto']?></small>
                                <div class="me-2 d-flex align-items-center">
                                    ...
                                    <a href="config/proses_suka.php?FotoId=<?php echo $data['FotoId'] ?>" type="submit"
                                        ...
                                        <?php }else{ ?>
                                        <a href="config/proses_suka.php?FotoId=<?php echo $data['FotoId'] ?>"
                                            type="submit" name="suka">
                                            <ion-icon name="heart-outline" class="text-black"></ion-icon>
                                        </a><small>
                                            <?php }
                            ...
                            <form action="config/proses_komentar.php" method="POST">
                                ...
                                <div class="d-flex justify-content-center my-2 mt-4">
                                    <div class="input-group">
                                        ...
                                        <input class="form-control input" type="text" style="bottom: 0;"
                                            placeholder="Tambahkan Komentar" aria-label="" name="isikomentar"
                                            autocomplete="off">
                                        <button type="submit" name="kirimkomentar" class="btn btn-secondary">
            ...
            <div class="col-3">
                ...
                <div class="d-flex align-items-center justify-content-between mt-1 mb-4">
                    <a href="profil.php?UserId=<?= $data['UserId']?>" class="text-decoration-none"><small
                            class="fw-bold text-black username"><?php echo $data['Username']?></small></a>
                    <!-- nama pengguna -->
                    <!-- Icon -->
                    <div class="d-flex">
                        <div class="me-2 d-flex align-items-center">
    ...
    <footer>
        <div class="container-fluid px-5">
            <div class="row align-items-center d-flex">
                ...
                <div class="offset-4 col-6 text-end">
