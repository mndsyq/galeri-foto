...
<body>
            ...
            <div class="text-container">
                <?php 
                       ...
                       $sql = mysqli_query($koneksi, "SELECT * FROM gallery_user WHERE UserId='$UserId'");
                        ...
                        ?>
                <h2 class="fw-bold" style="margin-top:0; margin-bottom:5px;"><?php echo $data['Username']?></h2>
                ...
                <!-- Modal Edit Profil -->
                <button type="button" class="btnbtn btn btn-outline-secondary mt-3" data-bs-toggle="modal"
                                ...
                                <form action="config/aksi_pengguna.php" method="post">
                                    <div class="d-grid gap-3">
                                        ...
                                        <textarea type="text" class="form-control input" placeholder="Alamat"
                                            name="alamat" autocomplete="off"><?php echo $data['Alamat']?></textarea>
                                    </div>
                            </div>
    ...
    <div class="container-fluid px-5 pp mb-5">
        <?php
        $album = mysqli_query($koneksi, "SELECT * FROM gallery_album WHERE UserId='$UserId' ");
        while ($row = mysqli_fetch_array($album)){
        ?>
        <a href="profil_user.php?AlbumId=<?php echo $row['AlbumId']?>" class="bttn btn btn-secondary">
        ...
        if (isset($_GET['AlbumId'])){
            ...
            $query = mysqli_query($koneksi, "SELECT * FROM gallery_foto WHERE UserId='$UserId' AND AlbumId='$AlbumId' ");
            while($data = mysqli_fetch_array($query)){?>
            <div class="col-3 g-4 mt-4">
                            ...
                            <form action="config/aksi_foto.php" method="post" enctype="multipart/form-data">
                                ...
                                <div class="my-4">
                                    <input type="text" class="form-control input" placeholder="Judul Foto"
                                        name="judulfoto" value="<?php echo $data['JudulFoto']?>" autocomplete="off">
                                </div>
                                <div class="my-4">
                                    <input type="text" class="form-control input" placeholder="Deskripsi Foto"
                                        name="deskripsifoto" value="<?php echo $data['DeskripsiFoto']?>"
